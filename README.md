...
[Пример сайта.](https://burger-el-padrino.ru/)
...
## Как подключить логгер ошибок Rollbar
[Зарегистрируйтесь и получите инструкцию по интеграции django.](https://app.rollbar.com/)
Добавьте свой токен и имя окружения в `.env` файл:
```
